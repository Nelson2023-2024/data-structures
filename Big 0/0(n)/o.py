...
def print_items(integer):
    for i in range(integer): # the time complexity increases linearly based on the input size 0(n)
        print(i)            # the time complexity here is 0(1) as the computation always remains the same
